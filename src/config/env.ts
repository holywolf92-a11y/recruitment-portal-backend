...
export function validateEnv() {
  ...
  const optional = [
    ...
    'WHATSAPP_FLOW_REMINDER_CHECK_INTERVAL_MS',
    'WHATSAPP_FLOW_REMINDER_GAP_MS',
    'WHATSAPP_FLOW_REMINDER_MAX_COUNT',
    'WHATSAPP_FLOW_REMINDER_START_DELAY_MS',
    'WHATSAPP_CANDIDATE_REMINDER_CHECK_INTERVAL_MS',
    'WHATSAPP_CANDIDATE_REMINDER_IDLE_MS',
    'WHATSAPP_CANDIDATE_REMINDER_MAX_COUNT',
    'WHATSAPP_CANDIDATE_REMINDER_START_DELAY_MS',
    'WHATSAPP_APP_SECRET',
