...
export const WHATSAPP_INTENT_TAXONOMY: IntentDefinition[] = [
  ...
  },
  {
    ...
    patterns: [
      ...
      /(send|share|give|follow).*(link|links)/i,
    ],
  },
  {
    id: 'job_listings',
  ...
  },
  {
    ...
    patterns: [/login|log in|signin|sign in|password|username|dashboard|portal/i],
  },
  {
    ...
    patterns: [/status|update|progress|application|requirement|hiring|follow up|followup/i],
  },
  {
    id: 'document_help',
    label: 'Documents',
    ...
    patterns: [/document|documents|cv|resume|passport|cnic|visa/i],
  },
  {
    ...
    patterns: [/process|steps|screening|interview|visa|deployment|recruitment process/i],
  },
  {
  ...
  },
  {
    ...
    patterns: [/office|address|contact number|phone number|location|hours|timing/i],
  },
  {
    id: 'human_handoff',
    label: 'Human Handoff',
